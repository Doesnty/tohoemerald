...
static bool8 DoesTypePreventStatus(u16 species, u32 status)
{
    ...
    case STATUS1_FREEZE:
        ...
        break;
    case STATUS1_PARALYSIS:
        if (gBaseStats[species].type1 == TYPE_EARTH || gBaseStats[species].type1 == TYPE_ELECTRIC
            || gBaseStats[species].type2 == TYPE_EARTH || gBaseStats[species].type2 == TYPE_ELECTRIC)
            ret = TRUE;
        break;
    case STATUS1_BURN:
